...
LOCAL_CERTIFICATE := $(LOCAL_PATH)/certs/org.fitchfamily.android.dejavu
LOCAL_MODULE_CLASS := APPS
LOCAL_PRODUCT_MODULE := true
include $(BUILD_PREBUILT)
...
LOCAL_CERTIFICATE := $(LOCAL_PATH)/certs/org.microg.nlp.backend.ichnaea
LOCAL_MODULE_CLASS := APPS
LOCAL_PRODUCT_MODULE := true
include $(BUILD_PREBUILT)
...
LOCAL_CERTIFICATE := $(LOCAL_PATH)/certs/org.microg.nlp.backend.nominatim
LOCAL_MODULE_CLASS := APPS
LOCAL_PRODUCT_MODULE := true
include $(BUILD_PREBUILT)
